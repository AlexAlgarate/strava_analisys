...
class TestEpochTimeCalculation:
    def test_get_epoch_time_beginning_of_week(self):
        # Sunday
    ...
    def test_get_epoch_time_middle_of_week(self):
        # Wednesday
    ...
    def test_get_epoch_time_end_of_week(self):
        # Saturday
    ...
    def test_get_epoch_time_previous_week(self):
        # Current week
        with freeze_time("2024-01-24"):
